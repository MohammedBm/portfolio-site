...
class Work extends React.Component {
  render() {
    ...
    <section>
        ...
        <WorkTileOut title='Vivy' info='Mobile application' summary='Vivy is a electronic health record. Medical documents can be found on your phone - encrypted and visible only to you' img='images/preview/vivy.png' link='https://vivy.com'/>
